...
Loin tehtävää varten uuden vagrant virtuaalikoneen "gitkone". Ensimmäiseksi asensin siihen Salt-masterin ja gitin. Loin "puuhakansion" ja sinne git initillä "suolakoe" nimisen varaston. Kloonasin "suolax" varaston koneelleni:

<img width="883" height="151" alt="suola_kloonaus" src="https://github.com/user-attachments/assets/022d2b0b-8a9d-4a4c-b9ba-ed40cd18ac26" />

Kokeilin toimintoa komenolla
```
$ sudo salt-call --local --file-root puuhakansio/suolakoe/suolax/srv/salt state.apply
```

<img width="1112" height="958" alt="suolakomento_1" src="https://github.com/user-attachments/assets/21b3efb5-07c4-40e5-8ab3-8c9320ca4819" />


<img width="253" height="143" alt="muutokset_ja_kesto" src="https://github.com/user-attachments/assets/33b07890-79b5-4061-adf1-fc135cf0c71f" />

Toimi kuin piti, mitä nyt muutama varoitus herjasi. 
Pyöräytin komennon vielä uudestaan:


<img width="1114" height="835" alt="suola_toka_kierros" src="https://github.com/user-attachments/assets/3e2e354e-b47d-4aeb-a3fd-134256a91f77" />

Mitään uutta ei tapahtunut.
Lopuksi totean että komennosta tuli kyllä hassun pitkä, olisi saanut lyhyemmäksi jos ei olisi tehnyt noita kansoita niin innolla.
